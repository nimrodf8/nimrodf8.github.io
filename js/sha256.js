/* Small SHA-256 used to hash the parent passwords and the children's PINs.
   crypto.subtle is not available when the page is opened straight from disk
   (file://), so this pure-JS version keeps one code path everywhere. */
(function (global) {
  "use strict";
